...
public interface IPostReadModelRepository
{
    ...
    Task<IReadOnlyList<PostPageDto>> GetPagePostsCursorAsync(DateTimeOffset? cursorCreatedAt = null, Guid? cursorId = null, int take = 10, CancellationToken ct = default);
}